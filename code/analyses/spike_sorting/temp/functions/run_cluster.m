...
% !!!!!! COMMENTED OUT AND ADDED BY YAIR FOR DEBUGGING !!!!!!!!!!!!!!1
% fname_in=handles.par.fname_in;
fname_in = fname;
handles.par.randomseed = 0;
% ----------- !!!!!!!!!!!! ------------------
...
switch handles.par.system
   ...
   otherwise  %(GLNX86, GLNXA64, GLNXI64 correspond to linux)
        if exist([pwd '/cluster_linux.exe'])==0
            ...
            % ADDED BY YAIR ---
            directory = '/neurospin/unicog/protocols/intracranial/single_unit/Code/spike_sorting/wave_clus-testing/SPC';
            % -------------
            copyfile(directory,pwd);
        end
