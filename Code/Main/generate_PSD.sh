...
for PATIENT in $PATIENTS; do
    for DTYPE in $DTYPES; do
        ...
        filename_py="generate_PSD.py --patient "$PATIENT" --data-type "$DTYPE
        output_log='logs/out_generate_PSD_'$PATIENT'_'$DTYPE
        error_log='logs/err_generate_PSD_'$PATIENT'_'$DTYPE
        job_name=$PATIENT'_'$DTYPE
