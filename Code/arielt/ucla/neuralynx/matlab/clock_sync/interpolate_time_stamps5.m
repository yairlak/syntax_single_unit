load ~/ucla/analysis5/cheetah_times_relative.txt
load ~/ucla/analysis5/neuroball_times_relative.txt


b = regress(cheetah_times_relative(49:end), ...
            [neuroball_times_relative(8:end), ...
             ones(length(neuroball_times_relative(8:end)), 1)]);
