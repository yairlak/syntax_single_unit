...
for i_channel, ch_name in enumerate(ch_names):
    ...
    fname_fig = os.path.join(args.path2figures, 'rf_coef_' + fname + f'_{ch_name}.png')
    ...
    fname_fig = os.path.join(args.path2figures, 'rf_coef_' + fname + f'_{ch_name}_groupped.png')
    fig_coef.savefig(fname_fig)
    plt.close(fig_coef)
    print('Figure saved to: ', fname_fig)
    ...
    fname_fig = os.path.join(args.path2figures, 'rf_r2_' + fname + f'_{ch_name}_groupped.png')
