% !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
% WORKS ONLY WITH OLD VERSION OF MATLAB. TESTED WITH MATLAB 2014a
% !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
for i = 1:152
    ...
    [x, Fs] = audioread(['../../../../Paradigm/Stimuli/Audio/normalized/resampled_16k/' num2str(i) '.wav']);	% 8k sample rate
    x = x(:, 1);
    ...
    h = aud_plot(y, paras);
    saveas(h, ['../../../../Paradigm/Stimuli/Audio/normalized/resampled_16k/' num2str(i) '_acoustic_features.png'])
    %close(h)
    ...
    fcorname = ['../../../../Paradigm/Stimuli/Audio/normalized/resampled_16k/' num2str(i) '.cor'];
    ...
    colormap(jet);
    rst_view(rst, rv, sv);
    saveas(gca, ['../../../../Paradigm/Stimuli/Audio/normalized/resampled_16k/' num2str(i) '_cor.png'])
    ...
    save(['../../../../Paradigm/Stimuli/Audio/normalized/resampled_16k/' num2str(i) '_acoustic_features.mat'], 'auditory_spectrum', 'paras', 'Fs', 'signal_waveform', 'cr')
end
