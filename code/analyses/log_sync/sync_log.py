...
parser.add_argument('--IXs-block-logs', default=[1,2,3,4,5,6], help='Since there could be more cheetah logs than block, these indexes define the log indexes of interest')
