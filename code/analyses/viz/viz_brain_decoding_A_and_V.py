...
for data_type_filter in data_type_filters:
    for comparison_name in comparison_names:
        ...
        for block_type in block_types:
            ...
            dict_dfs[block_type] = df_whole_brain
        ...
        for i_hemi, hemi in enumerate(hemis):
            ...
            for label in labels:
                dict_scores_sig_mean = {}
                dict_scores_sig_mean['visual'], dict_scores_sig_mean['auditory'] = [], []
                for block_type in block_types:
                    df_roi = dict_dfs[block_type].loc[dict_dfs[block_type]['ROI'] == label.name]
                    if not df_roi.empty:
                        ...
                        if scores_sig.size>0:
                            ...
                            dict_scores_sig_mean[block_type] = scores_sig_mean
                if dict_scores_sig_mean['visual'] and dict_scores_sig_mean['auditory']:
                    mean_value = (dict_scores_sig_mean['visual'] + dict_scores_sig_mean['auditory'])/2
                    colors[label.vertices, :] = plt.cm.RdBu_r(mean_value)[:3]
                    print(comparison_name, data_type_filter, label.name, mean_value)
                    
                    
                
                # In[14]:
                
            fn = f'../../../Figures/viz_brain/decoding_both_modalities_{comparison_name}_{hemi}_{block_type}_{data_type_filter}'
            ...
            print(f'Saved to {fn}')
        fn = f'../../../Figures/viz_brain/decoding_both_modalities_{comparison_name}_{block_type}_{data_type_filter}'
