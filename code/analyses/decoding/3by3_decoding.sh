# ROI based
echo "nohup python 3by3_decoding.py --level phone --data-type_filter micro_raw --ROIs Brodmann.22-lh Brodmann.41-lh Brodmann.22-rh Brodmann.41-rh --smooth 10 --decimate 10 &"
